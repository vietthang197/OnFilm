...
<html lang="en">
<head>
    <title>OnFilm Firebase notification</title>
    <meta charset="utf-8">
...
<div class="container">
    <div class="row">
        <div class="col-lg-6">
            <h2>Send Firebase Push Notification | OnFilmCinema</h2>
            
        
            <hr />
            <form action="" method="post">
                
                <button type="submit" class="btn btn-primary">Gửi thông báo đến các device</button><br><br>
                ...
                <div class="form-group">
                    ...
                    <input type="text" disabled value="automatically insert" class="form-control" id="firebase_api" placeholder="Enter Firebase Server API Key" name="firebase_api">
                </div>
                <div class="form-group" id="firebase_token_group">
                    <label for="firebase_token">Firebase Token:</label>
                    <input type="text" disabled value="automatically insert" class="form-control" id="firebase_token" placeholder="Enter Firebase Token" name="firebase_token">
                </div>
        ...
        <div class="col-lg-6">
            ...
            if(isset($_POST['title'])){
                ...
                $firebase_api = 'AAAA0D4gU_0:APA91bEDShVneVSR6Um9rHy9uOe7ZfCaq7Y2-oKBb534sumxGFRTuBkY3SORbdlwLxOmsbiCn70bnHypCleuz7nXGUyRVJjH3iMvP059GVUEVKLKTsQik4MebxdFZlgQm9ZWBzY_yu7F';
                ...
                $sql = "SELECT * FROM device_token";
                $resl = mysqli_query($conn,$sql);
                if($resl->num_rows>0){
                    while ($row = $resl->fetch_assoc()){
                        $token_firebase = $row['Token'];
                        $fields = array(
                            'to' => $token_firebase,
                            'notification'=>$datas,
                            'data' => $requestData,
